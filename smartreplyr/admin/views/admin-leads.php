<div class="wrap smartreplyr-wrap">
    ...
    <a href="#" id="smartreplyr-export-csv" class="page-title-action">Export CSV</a>
            ...
            <?php else : ?>
                <?php foreach ( $leads as $lead ) : ?>
                    <tr>
                        ...
                        <td>
                            <span class="sr-badge"><?php echo esc_html( $lead['course_interest'] ?: 'General' ); ?></span>
                        </td>
                        <td>
                            ...
                            <?php if ( ! empty( $lead['utm_source'] ) ) : ?>
                                <br><small class="sr-utm">[<?php echo esc_html( $lead['utm_source'] ); ?> / <?php echo esc_html( $lead['utm_medium'] ); ?>]</small>
                            <?php endif; ?>
                        </td>
                        <td>
                            <span class="sr-status-icon <?php echo $lead['webhook_sent'] ? 'green' : 'gray'; ?>" title="Webhook CRM Delivery">Sync</span>
                            <span class="sr-status-icon <?php echo $lead['email_sent'] ? 'green' : 'gray'; ?>" title="Email Delivery">Mail</span>
                        </td>
                        <td>
