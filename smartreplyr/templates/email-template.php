...
<body style="margin:0;padding:20px;background:#f3f4f6;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    ...
    <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(0,0,0,0.05);">
        ...
        <div style="background:<?php echo esc_attr( $color ); ?>;padding:30px;text-align:center;">
            ...
            <p style="margin:10px 0 0;color:rgba(255,255,255,0.9);font-size:15px;"><?php echo esc_html( $site ); ?> — SmartReplyr</p>
        </div>
        ...
        <div style="background:#f9fafb;padding:25px 30px;border-top:1px solid #e5e7eb;text-align:center;">
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=smartreplyr-leads' ) ); ?>" style="display:inline-block;background:<?php echo esc_attr( $color ); ?>;color:#ffffff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;">View Leads Dashboard</a>
            <p style="margin:15px 0 0;font-size:12px;color:#9ca3af;">This was an automated notification from the SmartReplyr WordPress Plugin.</p>
        </div>
